# How to deploy crunchbase-esque
...
sudo service unicorn_crunchbase_esque <start|stop|restart>
sudo service sidekiq_crunchbase_esque <start|stop>
```
...
```
/home/deployer/apps/crunchbase_esque/shared/.env.production
```

After making changes to this file, be sure to restart the application:

```
sudo service unicorn_crunchbase_esque restart
sudo service sidekiq_crunchbase_esque stop
sudo service sidekiq_crunchbase_esque start
```
